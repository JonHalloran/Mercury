...
class RouteShow extends React.Component {
    ...
    componentDidMount() {
        ...
        this
            .props
            .retrieveRoute(this.props.match.params.routeId)
    ...
    componentWillReceiveProps(newProps) {
        if (this.props.match.params.routeId !== newProps.match.params.routeId) {
            this
                .props
                .retrieveRoute(newProps.match.params.routeId)
    ...
    render() {
        ...
        let modal = this.state.modal
            ? <RunModalConatainer toggleModal={this.toggleModal}/>
            : "";
        return (
            ...
            <div className={'route-show'}>
                ...
                <aside className={'route-show-aside'}>
                    <div className={'route-show-aside-buttons'}>
                        <button
                            className={'route-show-create-route-button'}
                            onClick={() => this.props.history.push('/create_route/')}>
                            Create Route
                        </button>
                        <button className={'route-show-log-workout'} onClick={this.toggleModal}>Log Workout
                        </button>
                    </div>
                </aside>
                {modal}
