...
class CreateRoute extends React.Component {
    constructor(props) {
        ...
        this.handlChangeZipcode = this
            .handlChangeZipcode
            .bind(this);
        this.handleToggleRouteDetails = this
            .handleToggleRouteDetails
            .bind(this);
        this.handleNewRoute = this
            .handleNewRoute
            .bind(this);
    ...
    handleToggleRouteDetails() {
        this.setState({
            showRouteDetails: !this.state.showRouteDetails
        });
    }
    ...
    handleNewRoute(e) {
        ...
        this
            ...
            .then(response => this.props.history.push(`/routes/${response.payload.route.id}`));
    }
            ...
            <div className={'create-route-page'}>
                <aside className={'create-route-sidebar'}>
                    ...
                    <div className={'route-details-root'}>
                        <span onClick={() => this.handleToggleRouteDetails()}>Route Details</span>
                        {errors}
                        {rootDetails}
                    </div>
                </aside>
